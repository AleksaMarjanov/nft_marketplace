          ...
          <div className="mt-4">
            <div {...getRootProps()} className={fileStyle}>
              ...
              <div className="flexCenter flex-col text-center">
                <p className="font-poppins dark:text-white text-nft-black-1 text-xl font-semibold">JPG, PNG, GIF, SVG, WEBP Max 100mb.</p>
                ...
                <p className="font-poppins dark:text-white text-nft-black-1 text-sm font-semibold">Drag and Drop File</p>
